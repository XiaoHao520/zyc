        ...
        <form class="form auto-form" method="post" autocomplete="off" style="display: inline-block;width: 45%;"
            ...
            <div class="form-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-9">
                        <input class="form-control" type="text" name="username" value="<?= $shop->username ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-3 text-right">
                        <label class=" col-form-label required">门店管理员密码：</label>
                    </div>
                    <div class="col-9">
                        <input class="form-control" type="text" name="password" value="<?= $shop->password ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-3 text-right">
