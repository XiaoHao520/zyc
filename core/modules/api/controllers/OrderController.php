...
//        $form->order_no = $order_no;
    ...
    public function actionLocation()
    {
     ...
     public function actionChangeDate(){
         ...
         $order_info=\Yii::$app->request->get();
         $form = new OrderDetailForm();
         $form->store_id=$this->store->id;
         $form->user_id = \Yii::$app->user->id;
         $form->order_id=$order_info['order_id'];
         $form->date=$order_info['date'];
         $this->renderJson($form->changeDate());
     }
    public function actionChangeTime(){
        ...
        $form->user_id = \Yii::$app->user->id;
        $form->order_id=$order_info['order_id'];
        $form->time=$order_info['time'];
        $this->renderJson($form->changeTime());

    }
    public function actionChangeRoute(){
        $order_info=\Yii::$app->request->get();
        $form = new OrderDetailForm();
        $form->store_id=$this->store->id;
        $form->user_id = \Yii::$app->user->id;
        $form->order_id=$order_info['order_id'];
        $form->route=$order_info['attr'];
        $this->renderJson($form->changeRoute());
