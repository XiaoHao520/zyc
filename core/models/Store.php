...
class Store extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['admin_id', 'is_delete', 'acid', 'user_id', 'wechat_platform_id', 'wechat_app_id', 'show_customer_service', 'delivery_time', 'after_sale_time', 'use_wechat_platform_pay', 'cat_style','cut_thread', 'cat_goods_cols', 'over_day', 'is_offline', 'is_coupon', 'cat_goods_count', 'send_type', 'nav_count', 'integral','dial'], 'integer'],
