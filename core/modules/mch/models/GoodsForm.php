...
class GoodsForm extends Model
{
    ...
    public function rules()
    {
        return [
            ...
            [['store_id', 'sort', 'virtual_sales', 'freight', 'share_type', 'quick_purchase', 'hot_cakes', 'capacity'], 'integer'],
            [['price', 'original_price', 'weight'], 'number'],
            [['price',], 'number', 'min' => 0.01,],
            [['detail', 'service', 'cover_pic', 'video_url', 'time', 'parameter'], 'string'],
            [['name'], 'string', 'max' => 255],
    ...
    public function save()
    {
        ...
        if ($this->validate()) {
            ...
            $goods->time = $this->time;
            $goods->capacity = $this->capacity;
                ...
                [
                    'attr_list' => [
                        [
                            ...
                            'attr_detail' => $default_attr->attr_name
                        ],
                    ],
        ...
        foreach ($this->attr as $i => $item) {
            ...
            foreach ($item['attr_list'] as $a) {
                ...
                $new_attr_item['attr_list'][] = [
                    ...
                    'attr_detail'=>$attr_model->attr_detail
                ];
            }
