...
Source Database       : hs37

Target Server Type    : MYSQL
Target Server Version : 50554
File Encoding         : 65001

Date: 2018-01-12 11:43:50
*/
...
-- ----------------------------
INSERT INTO `hjmall_admin_permission` VALUES ('1', 'coupon', '优惠卷', '0', '1000');
INSERT INTO `hjmall_admin_permission` VALUES ('2', 'share', '分销中心', '0', '1000');
...
CREATE TABLE `hjmall_article` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='系统文章';

-- ----------------------------
-- Records of hjmall_article
-- ----------------------------
...
CREATE TABLE `hjmall_attr` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='商品规格';
...
CREATE TABLE `hjmall_attr_group` (
  ...
  `is_delete` smallint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='商品规格组';
...
CREATE TABLE `hjmall_banner` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='商店幻灯片';

-- ----------------------------
-- Records of hjmall_banner
-- ----------------------------
...
CREATE TABLE `hjmall_cat` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='商品分类';
...
CREATE TABLE `hjmall_color` (
  ...
  `addtime` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='颜色库';
...
CREATE TABLE `hjmall_coupon_auto_send` (
  ...
  `is_delete` smallint(6) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='优惠券自动发放';

-- ----------------------------
-- Records of hjmall_coupon_auto_send
-- ----------------------------
...
CREATE TABLE `hjmall_express` (
  ...
  `is_delete` smallint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=103 DEFAULT CHARSET=utf8 COMMENT='快递公司';
...
CREATE TABLE `hjmall_favorite` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='我喜欢的商品';

-- ----------------------------
-- Records of hjmall_favorite
-- ----------------------------
...
CREATE TABLE `hjmall_form_id` (
  ...
  `addtime` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='小程序form_id和prepay_id记录';

-- ----------------------------
-- Records of hjmall_form_id
-- ----------------------------
...
CREATE TABLE `hjmall_home_block` (
  ...
  `is_delete` smallint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='首页自定义版块';

-- ----------------------------
-- Records of hjmall_home_block
-- ----------------------------
...
CREATE TABLE `hjmall_home_nav` (
  ...
  `is_delete` smallint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='首页导航图标';

-- ----------------------------
-- Records of hjmall_home_nav
-- ----------------------------
...
-- ----------------------------
-- Records of hjmall_integral_log
-- ----------------------------
...
-- ----------------------------
-- Records of hjmall_mail_setting
-- ----------------------------
...
-- ----------------------------
-- Records of hjmall_miaosha_goods
-- ----------------------------
...
CREATE TABLE `hjmall_order_comment` (
  ...
  `addtime` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='订单评价';

-- ----------------------------
-- Records of hjmall_order_comment
-- ----------------------------
...
-- ----------------------------
-- Records of hjmall_order_detail
-- ----------------------------
...
CREATE TABLE `hjmall_order_form` (
  ...
  `is_delete` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='订单自定义表单信息';

-- ----------------------------
-- Records of hjmall_order_form
-- ----------------------------
...
-- ----------------------------
-- Records of hjmall_order_message
-- ----------------------------
...
CREATE TABLE `hjmall_order_refund` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='售后订单';

-- ----------------------------
-- Records of hjmall_order_refund
-- ----------------------------
...
-- ----------------------------
-- Records of hjmall_plugin
-- ----------------------------
INSERT INTO `hjmall_plugin` VALUES ('1', '');
INSERT INTO `hjmall_plugin` VALUES ('2', '');
INSERT INTO `hjmall_plugin` VALUES ('3', '');
...
CREATE TABLE `hjmall_postage_rules` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='运费规则';

-- ----------------------------
-- Records of hjmall_postage_rules
-- ----------------------------
...
CREATE TABLE `hjmall_printer` (
  ...
  `addtime` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='小票打印机';

-- ----------------------------
-- Records of hjmall_printer
-- ----------------------------
...
CREATE TABLE `hjmall_printer_setting` (
  ...
  `addtime` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='打印设置';

-- ----------------------------
-- Records of hjmall_printer_setting
-- ----------------------------
...
-- ----------------------------
-- Records of hjmall_pt_goods_pic
-- ----------------------------
...
-- ----------------------------
-- Records of hjmall_pt_order_comment
-- ----------------------------
...
-- ----------------------------
-- Records of hjmall_pt_order_detail
-- ----------------------------
...
CREATE TABLE `hjmall_qrcode` (
  ...
  `addtime` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='海报图的设置';

-- ----------------------------
-- Records of hjmall_qrcode
-- ----------------------------
...
CREATE TABLE `hjmall_setting` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='分销商佣金设置';
...
CREATE TABLE `hjmall_shop` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='门店设置';

-- ----------------------------
-- Records of hjmall_shop
-- ----------------------------
...
CREATE TABLE `hjmall_store` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='商城';
...
CREATE TABLE `hjmall_topic_favorite` (
  ...
  `is_delete` smallint(6) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='用户收藏的专题';

-- ----------------------------
-- Records of hjmall_topic_favorite
-- ----------------------------
...
-- ----------------------------
-- Records of hjmall_upload_config
-- ----------------------------
...
CREATE TABLE `hjmall_upload_file` (
  ...
  `is_delete` smallint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='用户上传的文件';
...
CREATE TABLE `hjmall_user_share_money` (
  ...
  `addtime` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='用户佣金明细表';

-- ----------------------------
-- Records of hjmall_user_share_money
-- ----------------------------
...
-- ----------------------------
-- Records of hjmall_we7_user_auth
-- ----------------------------
INSERT INTO `hjmall_we7_user_auth` VALUES ('1', '1', '[\"coupon\",\"share\",\"topic\",\"video\",\"miaosha\",\"pintuan\",\"book\"]');
...
CREATE TABLE `hjmall_wechat_app` (
  ...
  `is_delete` smallint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='微信小程序';
...
-- ----------------------------
-- Records of hjmall_wechat_platform
-- ----------------------------
...
CREATE TABLE `hjmall_yy_cat` (
  ...
  `is_delete` smallint(1) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='商城预约';

-- ----------------------------
-- Records of hjmall_yy_cat
-- ----------------------------
...
CREATE TABLE `hjmall_yy_form` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='预约自定义表单';

-- ----------------------------
-- Records of hjmall_yy_form
-- ----------------------------
...
-- ----------------------------
-- Records of hjmall_yy_goods_pic
-- ----------------------------
...
CREATE TABLE `hjmall_yy_order` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='预约订单表';

-- ----------------------------
-- Records of hjmall_yy_order
-- ----------------------------
...
-- ----------------------------
-- Records of hjmall_yy_order_comment
-- ----------------------------
...
-- ----------------------------
-- Records of hjmall_yy_order_form
-- ----------------------------
...
ADD COLUMN `bank`  varchar(255) NULL COMMENT '开户行' AFTER `name`;

ALTER TABLE `hjmall_setting`
ADD COLUMN `bank`  tinyint NULL COMMENT '银行卡支付  0 --不使用  1--使用' AFTER `price_type`;

/* 2.1.2 */
ALTER TABLE `hjmall_store`
ADD COLUMN `cut_thread`  smallint(1) NULL DEFAULT NULL COMMENT '分类分割线   0关闭   1开启',
ADD COLUMN `dial`  smallint(1) NULL DEFAULT NULL COMMENT '一键拨号开关  0关闭  1开启' AFTER `integration`,
ADD COLUMN `dial_pic`  tinytext CHARACTER SET utf8 NULL COMMENT '拨号图标' AFTER `dial`;

/* 2.1.2.1 */
ALTER TABLE `hjmall_order_message`
ADD COLUMN `type`  smallint(1) NULL DEFAULT 0 COMMENT '订单类型  0--已下订单   1--售后订单';


/* 2.1.3.1 */
ALTER TABLE `hjmall_pt_goods`
ADD COLUMN `use_attr`  smallint(1) UNSIGNED NOT NULL DEFAULT 1 COMMENT '是否使用规格：0=不使用，1=使用' ;

/* 2.1.4 */
ALTER TABLE `hjmall_order`
ADD COLUMN `express_price_1`  decimal(10,2) NULL COMMENT '减免的运费';

ALTER TABLE `hjmall_sms_setting`
ADD COLUMN `tpl_refund`  longtext NULL COMMENT '退款模板参数';
...
/* 2.1.5 */
ALTER TABLE `hjmall_cash`
ADD COLUMN `bank_name`  varchar(30) CHARACTER SET utf8 NULL DEFAULT NULL COMMENT '开户行名称';
...
CREATE TABLE `hjmall_pt_order_refund` (
  ...
  `order_id` int(11) NOT NULL,
  `order_detail_id` int(11) NOT NULL,
  `order_refund_no` varchar(255) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '退款单号',
  `type` smallint(6) NOT NULL DEFAULT '1' COMMENT '售后类型：1=退货退款，2=换货',
  `refund_price` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '退款金额',
  `desc` varchar(500) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '退款说明',
  `pic_list` longtext CHARACTER SET utf8 COMMENT '凭证图片列表：json格式',
  `status` smallint(1) NOT NULL DEFAULT '0' COMMENT '状态：0=待商家处理，1=同意并已退款，2=已同意换货，3=已拒绝退换货',
  `refuse_desc` varchar(500) CHARACTER SET utf8 NOT NULL DEFAULT '' COMMENT '拒绝退换货原因',
  `addtime` int(11) NOT NULL DEFAULT '0',
  `is_delete` smallint(1) NOT NULL DEFAULT '0',
  `response_time` int(11) NOT NULL DEFAULT '0' COMMENT '商家处理时间',
  PRIMARY KEY (`id`)
) DEFAULT CHARSET=utf8 COMMENT='拼团订单售后表';

/* 2.1.6 */

INSERT INTO `hjmall_admin_permission` (`id`, `name`, `display_name`, `is_delete`, `sort`) VALUES ('5', 'copyright', '版权设置', '0', '1000');

INSERT INTO `hjmall_plugin` VALUES ('5', '');
...
CREATE TABLE `hjmall_pt_robot` (
  ...
  `store_id` int(11) unsigned NOT NULL,
  PRIMARY KEY (`id`)
) DEFAULT CHARSET=utf8 COMMENT='拼团机器人表';