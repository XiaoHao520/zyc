...
class StoreSettingForm extends Model
{
    ...
    public function rules()
    {
        return [
            ...
            [['show_customer_service', 'delivery_time', 'after_sale_time', 'cat_style','cut_thread', 'cat_goods_cols', 'over_day', 'is_offline', 'is_coupon', 'cat_goods_count', 'send_type', 'nav_count', 'integral','dial'], 'integer'],
