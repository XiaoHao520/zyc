        ...
        <form class="auto-form" method="post" return="<?= $returnUrl ?>">
            ...
            <div class="head">
                <div class="head-content" flex="dir:left">
                    ...
                    <a flex="cross:center" class="head-step" href="#step4">地理位置</a>
                </div>
            </div>
            ...
            <div class="step-block" flex="dir:left box:first">
                ...
                <div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                  <!--          <input class="form-control short-row" type="text" name="model[dock]"
                                   value="<?/*= $goods['dock'] */?>">-->
                            ...
                            <label class="radio-inline">
                                ...
                                <input type="hidden" name="model[address]" value="<?=$dock['address']?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            <input class="form-control" type="text" name="model[time]"
                                   value="<?= $goods->time ?>">
                            <div class="fs-sm">格式如：00:10,02:10。多个请使用英文逗号,分隔</div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-9">
                            <textarea class="short-row" id="parameter"
                                      name="model[parameter]"><?= $goods['parameter'] ?></textarea>
                            </div>
                            ...
                            <div class="col-9">
                                ...
                                <div v-for="(attr_group,i) in attr_group_list" class="attr-group">
                                    ...
                                    <div class="attr-list">
                                        ...
                                        <div style="display: inline-block;width: 400px;margin-top: .5rem">
                                            <div class="input-group attr-input-group" style="border-radius: 0">
                                            <span class="input-group-addon"
                                                  style="padding: .35rem .35rem;font-size: .8rem">规格值</span>
                                                <input class="form-control form-control-sm add-attr-input attr-name"
                                                       placeholder="如红色、白色">

                                                <span class="input-group-addon"
                                                      style="padding: .35rem .35rem;font-size: .8rem">规格描述</span>
                                                <input class="form-control form-control-sm add-attr-input attr-detail"
                                                       placeholder="此路线很好玩">
                                    ...
                                    <table class="table table-bordered attr-table">
                                        ...
                                        <tr v-for="(item,index) in checked_attr_list">
                                            <td v-for="(attr,attr_index) in item.attr_list">
                                                ...
                                                <input type="hidden" style="width: 40px"
                                                       v-bind:name="'attr['+index+'][attr_list]['+attr_index+'][attr_detail]'"
                                                       v-bind:value="attr.attr_detail">
           ...
           <!-- <div class="step-block" flex="dir:left box:first">
                ...
                <div>
                    <div class="form-group row">
                        <div class="col-3 text-right">
                            <label class=" col-form-label required">商品经度：</label>
                        </div>
                        <div class="col-9">
                            <input class="form-control" type="text" name="model[longitude]"
                                   value="<?/*= $goods->longitude */?>">
                            <div class="fs-sm">商品经纬度可以在地图上选择，也可以自己添加</div>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-3 text-right">
                            <label class="col-form-label required">商品纬度：</label>
                        </div>
                        <div class="col-9">
                            <input class="form-control" type="text" name="model[latitude]"
                                   value="<?/*= $goods->latitude */?>">
                            <div class="fs-sm">商品经纬度可以在地图上选择，也可以自己添加</div>
                        </div>
                    </div>
                    <div class="form-group row">
...
//            $(".cat-id").val(cat_id);
    ...
    $(document).on("click", ".add-attr-btn", function () {
        var name = $(this).parents(".attr-input-group").find(".attr-name").val();
        var detail = $(this).parents(".attr-input-group").find(".attr-detail").val();
        console.log(detail)
        ...
        page.attr_group_list[index].attr_list.push({
         ...
         console.log(page.attr_group_list[index].attr_list);
        ...
        for (var i in page.attr_group_list) {
            for (var j in page.attr_group_list[i].attr_list) {
                var object = {
                    ...
                    attr_detail: page.attr_group_list[i].attr_list[j].attr_detail,
                };
                if (!array[i])
                    array[i] = [];
                array[i].push(object);
...
<script>
    function doSubmit() {
        $("input[name='time-item']:checked").each(function () {
            i
